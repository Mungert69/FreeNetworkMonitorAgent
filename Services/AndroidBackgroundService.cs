...
#pragma warning disable CA1416, CA1422
                    ...
                    var viewAction = new Notification.Action.Builder(
                     ...
                     notification = new Notification.Builder(this, "channel_id")
                        ...
                        .SetSmallIcon(NetworkMonitorAgent.Resource.Drawable.logo)
                        .Build();
...
#pragma warning disable CS0618
                    ...
                    Notification notification = new NotificationCompat.Builder(this)
                                   ...
                                   .AddAction(NetworkMonitorAgent.Resource.Drawable.view, "Open", GetViewAppPendingIntent()) // Ensure you have an icon for 'View App'
                                   .Build();
                    StartForeground(SERVICE_RUNNING_NOTIFICATION_ID, notification);
